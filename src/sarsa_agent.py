...
class ExpectedSarsaAgent():
    ...
    def policy(self, observation):
        if self.q[observation]:
            ...
            raise ValueError("Policy empty for this state, train you agent first")
        return pi
    ...
    def agent_step(self, reward, state):
        ...
        pi = np.ones(self.num_actions) * self.epsilon / self.num_actions + (current_q == q_max) * (1 - self.epsilon) / np.sum(current_q == q_max)
